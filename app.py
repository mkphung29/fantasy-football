...
import pandas as pd
from scraper import scrape_quarterback_stats, scrape_runningback_stats, scrape_wide_receiver_stats, scrape_tight_end_stats, scrape_defense_stats, scrape_kicker_stats
from analyze import calculate_qb_rating, calculate_rb_rating, calculate_wr_rating, calculate_te_rating, calculate_dst_rating, calculate_k_rating
